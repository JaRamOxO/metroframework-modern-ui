...
internal static class MetroFrameworkAssembly
{
    ...
    internal const string Copyright = "Copyright \x00a9 2011 Sven Walter, Dennis Magno, JaRamOxO.  All rights reserved.";
    internal const string Company = "Sven Walter, Dennis Magno, JaRamOxO";
